...
-- Tạo bảng
CREATE TABLE vi_tri (ma_vi_tri INT PRIMARY KEY AUTO_INCREMENT, ten_vi_tri VARCHAR(50) NOT NULL);
CREATE TABLE trinh_do (ma_trinh_do INT PRIMARY KEY AUTO_INCREMENT, ten_trinh_do VARCHAR(50) NOT NULL);
CREATE TABLE bo_phan (ma_bo_phan INT PRIMARY KEY AUTO_INCREMENT, ten_bo_phan VARCHAR(50) NOT NULL);
CREATE TABLE loai_khach (ma_loai_khach INT PRIMARY KEY AUTO_INCREMENT, ten_loai_khach VARCHAR(50) NOT NULL);
...
CREATE TABLE nhan_vien (
    ...
    email VARCHAR(100), dia_chi VARCHAR(200),
    ma_vi_tri INT, ma_trinh_do INT, ma_bo_phan INT,
...
CREATE TABLE khach_hang (
    ...
    ho_ten VARCHAR(100) NOT NULL, ngay_sinh DATE NOT NULL,
    gioi_tinh VARCHAR(10) NOT NULL, so_cmnd VARCHAR(20) NOT NULL,
    so_dien_thoai VARCHAR(15) NOT NULL, email VARCHAR(100), dia_chi VARCHAR(200),
    ma_loai_khach INT,
    FOREIGN KEY (ma_loai_khach) REFERENCES loai_khach(ma_loai_khach)
);

CREATE TABLE kieu_thue (ma_kieu_thue INT PRIMARY KEY AUTO_INCREMENT, ten_kieu_thue VARCHAR(50) NOT NULL);
CREATE TABLE loai_dich_vu (ma_loai_dich_vu INT PRIMARY KEY AUTO_INCREMENT, ten_loai_dich_vu VARCHAR(50) NOT NULL);
CREATE TABLE dich_vu (
    ma_dich_vu INT PRIMARY KEY AUTO_INCREMENT, ten_dich_vu VARCHAR(100) NOT NULL,
    dien_tich INT, chi_phi_thue DECIMAL(10, 2) NOT NULL,
    so_nguoi_toi_da INT, ma_kieu_thue INT, ma_loai_dich_vu INT,
    tieu_chuan_phong VARCHAR(50), mo_ta_tien_nghi_khac TEXT,
    dien_tich_ho_boi DECIMAL(10, 2), so_tang INT, dich_vu_mien_phi_di_kem TEXT,
...
CREATE TABLE dich_vu_di_kem (
    ...
    ten_dich_vu_di_kem VARCHAR(100) NOT NULL, don_vi VARCHAR(50), gia_tien DECIMAL(10, 2) NOT NULL
);

CREATE TABLE hop_dong (
    ma_hop_dong INT PRIMARY KEY AUTO_INCREMENT,
    ngay_bat_dau DATE NOT NULL, ngay_ket_thuc DATE NOT NULL,
    tien_dat_coc DECIMAL(10, 2) NOT NULL, tong_tien DECIMAL(10, 2) NOT NULL,
    ma_nhan_vien INT, ma_khach_hang INT, ma_dich_vu INT,
...
CREATE TABLE hop_dong_chi_tiet (
    ...
    so_luong INT NOT NULL, ma_hop_dong INT, ma_dich_vu_di_kem INT,
...
(5, 2, 4), (8, 2, 5), (15, 3, 6), (1, 3, 1), (3, 1, 3), (11, 3, 2), (1, 1, 1), (1, 1, 2), (2, 12, 2);
